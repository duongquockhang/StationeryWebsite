                     ...
                     <table class="table table-hover table-condensed">
                        ...
                        <tbody>
                           <?php
                               ...
                               ?>
                           <form action='<?php echo BASE_URL ?>/?url=giohang/updategiohang' method="POST">
                                    <?php
                                              $total=0;
                              ...
                              <tr class="tr">
                                 <td data-th="Hình ảnh">
                                    <div class="col_table_image col_table_hidden-xs"><img src="<?php echo BASE_URL?>/public/uploads/product/<?php echo $value['product_img']?>" alt="<?php echo $value['product_tittle']?>" class="img-responsive"/></div>
                                 </td>
                                 <td data-th="Sản phẩm">
                                    <div class="col_table_name">
                                       <h4 class="nomargin"><h4><?php echo $value['product_tittle']?></h4>
                                    </div>
                                 </td>
                                 ...
                                 <td class="actions aligncenter" data-th="">
                                    ...
                                    <button type="submit" value="<?php echo $value['product_id']?>" style="box-shadow: none" name="delete_cart" class="btn btn-sm btn-warning">Xóa</button>
                        ...
                        <div class="ch-contacts-details">
                           <ul class="contact-list">
                              <li class="addr">
                                 ...
                                 <p><em><strong>Văn Phòng Phẩm Thuận Khang</strong></em><br />
                                 <p>Trung Tâm Bán Hàng:</p>
                                 <p>KP3-P4-TP ĐÔNG HÀ-TỈNH QUẢNG TRỊ</p>
                                 <p>133 Lý Thường Kiệt </p>
                               
                               
                                 <p> Hotline:0375 773 568 (zalo)</p>
                                 </p>
                              </li>
                           </ul>
                           <div class="hiring-box">
                              <strong class="title">Chào bạn!</strong>
                              <p>Mọi thắc mắc bạn hãy gửi về mail của chúng tôi <strong>Khang1793@gmail.com</strong> chúng tôi sẽ giải đáp cho bạn.</p>
                     ...
                     <div class="contact_right">
                        <div class="form_contact_in">
                           <div class="box_contact">
                              <form name="FormDatHang" method="POST" action="<?php echo BASE_URL?>/?url=giohang/dathang" >
                                 <div class="content-box_contact">
                                    <div class="row">
                                       <div class="input">
                                          <label>Họ và tên: <span style="color:red;">*</span></label>
                                          <input type="text" name="hoten" required class="clsip">
                                       </div>
                                       <div class="clear"></div>
                                    </div>
                                    <!---row---->
