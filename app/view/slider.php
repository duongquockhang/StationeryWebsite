                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="http://localhost/Vanphongpham/public/images/khyenmai.jpg"  alt="Siêu khuyến mãi">
                        </div>
                ...
                <div class="row">
                    <div class="panel  panel-warning panel-styling">
                        ...
                        <div class="panel-body scrollable-panel">
                            ...
                            <?php foreach ($post_in as $ket =>$post){?>
                               
                            <div class="row">
                                <div class="col-md-4 col-xs-4 col-sm-4">
                                    <img src="http://localhost/Vanphongpham/public/uploads/post/<?php echo $post['img_post']?>">
                                </div>
                                <div class="col-md-8 col-xs-8 col-sm-8">
                                    <h4><?php echo $post['tittle_post']?></h4>
