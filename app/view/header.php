                    ...
                    <div class="bg_in">
                        ...
                        <nav class="menu_top">
                            <form class="search_form" method="get" action="">
                                <input class="searchTerm" name="search" placeholder="Tìm gì cứ nhập..." />
                        ...
                        <div class="cart_wrapper">
                            <div class="cols_50">
                                <div class="hot_line_top">
                                    ...
                                    <br/>
                                    <span class="red">Văn Phòng Phẩm Thuận Khang</span>
                                </div>
                            </div>
                            <div class="cols_50">
                                <div class="hot_line_top">
                                    ...
                                    <br/>
                                    <span class="red">133 Lý Thường Kiệt</span>
                                </div>
                            </div>
                            <div class="cols_50">
                                <!-- <div class="hot_line_top">
                                <span class="red" ><a href='<?php echo BASE_URL?>/?url=login'>Đăng Nhập</a>
                                   <a href="<?php echo BASE_URL?>/?url=login/dangky">Đăng ký</a>
                                </div> -->
                            </div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="search_top">
                            <div id='cssmenu'>
                                <ul>
                                    ...
                                    <li class=''><a href='<?php echo BASE_URL ?>/?url=index/lienhe'>Giới thiệu</a></li>
                                    
                                    <li class=''>

                                        <a href='<?php echo BASE_URL ?>/?url=sanpham/tatca'>Sản phẩm</a>
                                    ...
                                    <li class=''>
                                        <a href='<?php echo BASE_URL ?>/?url=tintuc/tatca'>Tin tức</a>
                                        <ul>
                                    ...
                                    <li class=''><a href='<?php echo BASE_URL ?>/?url=giohang/index'>Giỏ Hàng</a></li>
                                    <li class=''><a href='<?php echo BASE_URL ?>/?url=index/lienhe'>Liên hệ</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="clear"></div>
